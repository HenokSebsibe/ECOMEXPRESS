                        ...
                        <div className="checkout-item-details">
                            ...
                            <div className="checkout-item-controls">
                                <div className="quantity-controls">
                                    <button className="quantity-buttons" onClick={() => updateQuantity(item.productId, item.quantity - 1)}>-</button>
                                ...
                                <button className="btn btn-secondary btn-small" onClick={() => removeFromCart(item.productId)}>
                                    Remove
                                </button>
                            </div>
                        </div>
